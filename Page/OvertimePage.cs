...
{
    public partial class OvertimePage : UserControl
    {
        public OvertimePage()
        {
            InitializeComponent();
        ...
        private void Reload()
        {
            ...
            DataTable dataTable = otDAO.GetOvertimeTable(year, month);
            dataGridView1.DataSource = dataTable;
        }

        private void OvertimePage_Load(object sender, EventArgs e)
        {
            Reload();
        }
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int year = dateTimePicker1.Value.Year;
            int month = dateTimePicker1.Value.Month;
            otDAO.UpdateOvertime(year, month, day, id, check);
        }
